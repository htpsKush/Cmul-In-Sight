            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
                ...
                <div className="flex-[1.4] space-y-8 w-full break-words">
                    ...
                    <div className="flex flex-wrap items-center gap-4 pt-4">
                        {/* Link to the Work section */}
                        <Link
                            href="#work"
                            className="bg-accent text-black px-6 py-3 rounded-md font-bold text-xs uppercase tracking-wider hover:opacity-90 transition-all cursor-pointer whitespace-nowrap"
                        >
                            See Our Work
                        </Link>
                        ...
                        <Link
                            href="#about"
                            className="bg-zinc-900 text-white border border-zinc-800 px-6 py-3 rounded-md font-bold text-xs uppercase tracking-wider hover:bg-zinc-800 transition-all cursor-pointer whitespace-nowrap"
                        >
                            Learn About Us
                        </Link>
                    </div>
