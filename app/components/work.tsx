import { Twitter, Instagram, Globe, Music2 } from "lucide-react";

const OurWorks = () => {
  // Dummy data for your 4 project slots
  const works = [
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
        {works.map((work) => (
          <div key={work.id} className="group flex flex-col">
            {/* Image Placeholder */}
            <div className="aspect-video bg-zinc-950 rounded-xl overflow-hidden border border-zinc-900 group-hover:border-accent/30 transition-all duration-500 relative flex items-center justify-center">
               {/* swap the div below for:
                  <Image src="/your-image.jpg" fill className="object-cover" alt={work.title} /> 
               */}
               <div className="text-zinc-800 font-black uppercase tracking-[0.5em] text-[10px] select-none">
